...
### Added
- Hide promoted/sponsored posts from the LinkedIn feed
- Toggle filter on/off from the extension popup
- Blocked post counter per filter type with reset button
- MutationObserver-based detection to catch posts loaded on scroll
